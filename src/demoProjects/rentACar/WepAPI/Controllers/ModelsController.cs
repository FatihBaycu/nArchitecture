...
namespace WepAPI.Controllers
{
    ...
    public class ModelsController : BaseController
    {
        ...
        {
            GetListModelByDynamicQuery dynamicList = new GetListModelByDynamicQuery{ PageRequest = pageRequest ,Dynamic=dynamic};
            ModelListModel result = await Mediator.Send(dynamicList);
            return Ok(result);
